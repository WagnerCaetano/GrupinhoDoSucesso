...
public class FormularioAlteracaoHotel extends JFrame{
    ...
    public FormularioAlteracaoHotel(String NomeHotel){
        ...
        btnConfirmar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try{
                    ...
                    CRUDTodos.AlterarHoteis(new Hoteis(catHotelT.getText(),nHotelT.getText(),Double.parseDouble(rateHotelT.getText()),ruaHotelT.getText(),cidadeHotelT.getText()),NomeHotel, c);
                }
